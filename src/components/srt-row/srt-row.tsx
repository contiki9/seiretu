...
export class SrtRow {
  ...
  render() {
    return (
      <Host>
        <div class="row" data-justifyContent={this.justify} data-alignItems={this.align} data-alignContent={this.alignContent} data-nowrap={this.nowrap} data-column={this.column}>
          <slot></slot>
        </div>
      </Host>
    );
